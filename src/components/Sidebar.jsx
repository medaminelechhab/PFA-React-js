    ...
    return (
        <>
            ...
            <button data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar"
                ...
                <svg className="w-6 h-6 transform transition-transform duration-300 ease-in-out"
            ...
            <aside id="sidebar-multi-level-sidebar"
                ...
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    <ul className="space-y-2 font-medium">
                        {/* Élément de menu pour le tableau de bord avec un logo */}
                        <li>
                            <a href="#"
                        ...
                        {/* Élément de menu pour l'e-commerce avec un logo et un sous-menu */}
                        <li>
                            <button type="button"
                                ...
                                <svg className="w-3 h-3 transform transition-transform duration-300 ease-in-out"
                                     ...
                                     style={{ transform: isSubMenuOpen ? 'rotate(360deg)' : 'rotate(270deg)' }}>
                                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
                                          strokeWidth="2" d="m1 1 4 4 4-4"/>
                                </svg>
                            </button>
                            <ul id="dropdown-example" className={`py-2 space-y-2 ${isSubMenuOpen ? 'block' : 'hidden'}`}>
                                <li>
                                    <a href="#"
                                       className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Produits</a>
                                </li>
                                <li>
                                    <a href="#"
                                       className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Facturation</a>
                                </li>
                                <li>
                                    <a href="#"
                                       className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Facture</a>
                                </li>
                            </ul>
                        </li>
                        {/* Élément de menu pour le Kanban avec un logo */}
                        <li>
                            <a href="#"
                               className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg
                        ...
                        {/* Élément de menu pour la boîte de réception avec un logo et un badge de notification */}
                        <li>
                            <a href="#"
                               className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Boîte de réception</span>
                                <span
