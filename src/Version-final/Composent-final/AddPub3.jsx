...
const data = {
  ...
  "Menuisier": ["Menuisier en bâtiment", "Menuisier en mobilier", "Menuisier ébéniste", "Menuisier charpentier"],
  "Plombier": ["Plombier sanitaire", "Plombier chauffagiste", "Plombier installateur", "Plombier en dépannage"],
  "Électricien": ["Électricien bâtiment", "Électricien industriel", "Électricien installateur", "Électricien de maintenance"],
  "Peintre": ["Peintre en bâtiment", "Peintre décorateur", "Peintre industriel", "Peintre en carrosserie"],
  "Couvreur": ["Couvreur zingueur", "Couvreur ardoisier", "Couvreur chaumier", "Couvreur tuilier"],
  "Forgeron": ["Forgeron d'art", "Ferronnier", "Serrurier-métallier", "Soudeur"],
  "Carreleur": ["Carreleur mosaïste", "Carreleur marbrier", "Carreleur faïencier", "Carreleur poseur de sol"],
  "Plâtrier": ["Plâtrier staffeur", "Plâtrier traditionnel", "Plâtrier décorateur", "Plâtrier stucateur"],
  "Charpentier": ["Charpentier en bois", "Charpentier métallique", "Charpentier de marine", "Charpentier de menuiserie"],
  "Tailleur de pierre": ["Sculpteur sur pierre", "Tailleur de marbre", "Tailleur de granit", "Tailleur de calcaire"],
  "Cordonnier1": ["Cordonnier traditionnel", "Cordonnier réparateur", "Cordonnier bottier", "Cordonnier maroquinier"],
  "Tisserand": ["Tisserand de tapis", "Tisserand de soie", "Tisserand de laine", "Tisserand de coton"],
  "Bijoutier": ["Bijoutier créateur", "Bijoutier joaillier", "Bijoutier sertisseur", "Bijoutier en métaux précieux"],
  "Potier": ["Potier céramiste", "Potier traditionnel", "Potier moderne", "Potier sculpteur"],
  "Tapissier": ["Tapissier d'ameublement", "Tapissier décorateur", "Tapissier en siège", "Tapissier garnisseur"],
  "Coutelier": ["Coutelier d'art", "Coutelier forgeron", "Coutelier mécanicien", "Coutelier en cuisine"],
  "Maroquinier": ["Maroquinier designer", "Maroquinier fabricant", "Maroquinier réparateur", "Maroquinier artisanal"],
  "Maréchal-ferrant": ["Maréchal-ferrant traditionnel", "Maréchal-ferrant sportif", "Maréchal-ferrant orthopédiste", "Maréchal-ferrant de courses"],
  "Sellier": ["Sellier automobile", "Sellier harnacheur", "Sellier garnisseur", "Sellier décorateur"],
  "Restaurateur de meubles": ["Restaurateur de meubles anciens", "Restaurateur de meubles en bois", "Restaurateur de meubles en cuir", "Restaurateur de meubles en métal"],
  "Sculpteur": ["Sculpteur sur bois", "Sculpteur sur pierre", "Sculpteur sur métal", "Sculpteur sur argile"],
  "Graveur": ["Graveur sur métal", "Graveur sur bois", "Graveur sur pierre", "Graveur sur verre"],
  "Luthier": ["Luthier de guitare", "Luthier de violon", "Luthier de oud", "Luthier de percussions"],
  "Marbrier": ["Marbrier de décoration", "Marbrier funéraire", "Marbrier de construction", "Marbrier artistique"],
  "Relieur": ["Relieur d'art", "Relieur industriel", "Relieur restaurateur", "Relieur en papier"],
  "Sérigraphe": ["Sérigraphe textile", "Sérigraphe industriel", "Sérigraphe artistique", "Sérigraphe publicitaire"],
