                ...
                <div className="flex ">
                    ...
                    <div className="w-full">
                        ...
                        <p className="text-neutral-600 font-medium mb-2 text-[13px] mt-1 flex flex-wrap">
                            ...
                            <span className="whitespace-nowrap" data-controller="tooltip" title="" data-bs-original-title="Budget indicatif">{projectData.budget
                            }</span>
                            <span className="px-1.5">·</span>
                            <span className="whitespace-nowrap" data-controller="tooltip" title="" data-bs-original-title="Nombre d'offres">{nbrannoce}</span>
                            <span className="px-1.5">·</span>
                            <span className="px-1.5">·</span>
                        </p>
...
const ProjectCard = ({ projectData }) => {
    ...
    // Obtenir les composants de l'heure actuelle
    const hours = time.getHours().toString().padStart(2, '0'); // Heures au format HH
    const minutes = time.getMinutes().toString().padStart(2, '0'); // Minutes au format MM
    const seconds = time.getSeconds().toString().padStart(2, '0'); // Secondes au format SS

    // Formater l'heure pour l'affichage
    const formattedTime = `${hours}:${minutes}:${seconds}`
    return (
        <Link to={`/Find_Job/Detaille/${projectData.id}`}>
            <div className="mb-4  bg-white shadow-lg   rounded-2xl  p-6" id="project-420451" data-controller="project-preview" data-project-preview-url-value="/projects/420451-changement-de-nom-sur-un-flux-de-donnees-site-e-commerce-prestashop/project_preview" data-action="mouseleave->project-preview#showSummary">
                <div className="flex ">
                    <div className="hidden lg:block mr-4">
                        <div className="bg-gray-100 rounded-lg p-4">
                    ...
                    <div className="w-full">
                        ...
                        <p className="text-neutral-600 font-medium mb-2 text-[13px] mt-1 flex flex-wrap">
                            ...
                            <span className="px-1.5">·</span>
                            <span className="whitespace-nowrap" data-controller="tooltip" title="" data-bs-original-title="Nombre d'offres">{nbrannoce} offre</span>
                            <span className="px-1.5">·</span>
                            <span className="px-1.5">·</span>
                        </p>
                        <div className="mt-2  text-black " data-project-preview-target="summary">
                        ...
                        <div className="flex flex-wrap mt-1">
                            {projectData.services.map((service, index) => (
                                <React.Fragment key={index}>
                                    <a
                                        className="text-neutral-600 font-semibold no-underline mr-2"
                                        href={`/projects/c/${service.category}/sc/${service.task}`}
                                    >
                                        {service.task} .
                                    </a>
                                </React.Fragment>
                        ...
                        <div className="md:flex items-center justify-between mt-2">
                            <div className="text-muted text-ms">
                                <span>Il y a   {formattedTime}</span>
                                <span> par <span controller="tooltip" >Client #{projectData.idUser}</span>
