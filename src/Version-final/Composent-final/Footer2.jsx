...
const Footer2 = () => {
  return (
    <footer className="bg-gray-800 mx-3 mb-2    inset-x-0 bottom-2 rounded-b-3xl text-gray-400 py-8">
      <div className="container mx-auto px-7">
        <div className="flex justify-between flex-wrap">
          ...
          <div className="">
            <div className="flex items-center mb-4">
              <h4 className="text-white text-lg font-medium mr-1">
                En direct du blog
              </h4>
            ...
            <ul>
              <li className="mb-3">
                <a href="#" className="hover:text-white font-medium">
                  Comment percer sur Instagram en 2024 : les 5 conseils clés
                </a>
              </li>
              <li className="mb-3">
                <a href="#" className="hover:text-white font-medium">
                  Comment percer sur LinkedIn en 6 étapes ?
                </a>
              </li>
              <li className="mb-3">
                <a href="#" className="hover:text-white font-medium">
                  Le grand guide des tailles d'images pour Tumblr
                </a>
              </li>
              <li className="mb-3">
                <a href="#" className="hover:text-white font-medium">
                  Ouvrir un compte professionnel, le meilleur choix pour un
                  micro-entrepreneur
                </a>
              </li>
              <li className="mb-3">
                <a href="#" className="hover:text-white font-medium">
                  10 nouveaux outils à tester en mai 2024
                </a>
              </li>
              <li className="mb-3">
                <a href="#" className="hover:text-white font-medium">
                  Interview de Charlotte Delattre : Community Manager sur
                  Codeur.com
                </a>
              </li>
            </ul>
        ...
        <div className="flex justify-between mt-10 text-center">
          <p className="flex text-sm">
            © 2006 - 2024 Codeur.com est la première place de marché des
            freelances francophones.
          </p>
          <div className="flex">
            <a
              href="#"
              className="flex mr-4 border border-gray-400 bg-black rounded-md px-2.5 py-0"
            >
              <img
                className="size-7 mr-2 mt-1.5"
                src={AppleStore}
                alt="App Store"
              />
